...
│  └─ websearch_exa("library topic 2025")                     │
├─────────────────────────────────────────────────────────────┤
│  CODE SEARCH LAYER                                          │
...
| **Latest Info** | websearch_exa | `websearch_exa("query 2025")` |
...
| **Recency** | Information is current (2025+) |
...
- Outdated information (2024 or earlier without noting)
